                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <ul class="nav nav-pills flex-column" id="myTab" role="tablist">
                                ...
                                @foreach ($findings as $finding)
                                    <li class="nav-item">
                                        <a class="nav-link @if($i==0) active @endif" id="finding{{$finding->id}}-tab" href="#finding{{$finding->id}}" aria-controls="finding{{$finding->id}}" role="tab" data-toggle="pill" @if($i==0) aria-selected="true" @endif>
                        ...
                        <div class="col-md-10">
                            <div class="tab-content" id="myTabContent">
                                ...
                                @endphp
                                @foreach ($findings as $finding)
                                    <div class="tab-pane fade @if($j==0) show active @endif" id="finding{{$finding->id}}" role="tabpanel" aria-labelledby="finding{{$finding->id}}-tab">
...
<script>
    ...
    $('#modal_suspect').on('show.bs.modal', function (event) {
        ...
        $(this).find('#sus_img').attr('src', '/'+recipient.image);
        $('#image_container').show();
    })
</script>
@endsection
