        ...
        <div class="row align-items-stretch mb-5">
          <div class="col-md-6">
            <div class="form-group">
              ...
              >
                <option disabled value="">Choose woreda..</option>
              </select>
            ...
            <div class="form-group">
              <select
                ...
                v-model="station"
                :class="{
                  'is-invalid': validationErrors.hasOwnProperty('station_id'),
                }"
                name="station"
              ...
              >
               ...
               <div class="invalid-feedback d-block" v-if="validationErrors.station_id">{{validationErrors.station_id[0]}}</div>
            </div>
            <div>
              <select
                class="custom-select"
                ...
                v-model="crime"
                :class="{
                  'is-invalid': validationErrors.hasOwnProperty('type'),
                }"
                name="crime"
              >
                <option disabled value="">Choose crime type..</option>
                <option value="robbery">burglury</option>
                <option value="assault">assault</option>
                <option value="homicide">homicide</option>
              </select>
               <div class="invalid-feedback d-block" v-if="validationErrors.type">{{validationErrors.type[0]}}</div>
            </div>
            <br />
            <div class="input-group">
              <div class="custom-file">
                <input
                  ...
                  v-on:change="onFileChange"
                   :class="{
                  'is-invalid': validationErrors.hasOwnProperty('image'),
                }"
                name="image"
              ...
              <div class="invalid-feedback d-block" v-if="validationErrors.image">{{validationErrors.image[0]}}</div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group form-group-textarea mb-md-0">
              <textarea
                ...
                v-model="remarks"
                                :class="{
                  'is-invalid': validationErrors.hasOwnProperty('details'),
                }"
                name="remarks"
              ></textarea>
              <p class="help-block text-danger"></p>
              <div class="invalid-feedback d-block" v-if="validationErrors.details">{{validationErrors.details[0]}}</div>
            </div>
          </div>
        </div>
        <div class="text-center">
...
export default {
  ...
  methods: {
    ...
    complaints(e) {
      ...
      axios.post("/api/complaints_api", formData)
        .then(function (response) {
        ...
        .catch(function (error) {
            ...
            console.log(currentObj.validationErrors);
        });
    },
  },
};
